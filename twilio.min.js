...
c=0;c<b.length;c++)if(a.href=b[c].src,/(twilio\.js)|(twilio\.min\.js)$/.test(a.pathname))return{host:a.host,minified:/\.min\.js$/.test(a.pathname)}}(),p=l.minified?"/twilio.min.js":"/twilio.js",m=document.getElementsByTagName("script")[0],c=document.createElement("script");c.type="text/javascript";c.src="//"+l.host+"/libs/twiliojs/refs/5c1f1e8"+p;c.onload=c.onreadystatechange=function(){c.readyState&&"loaded"!=c.readyState||(g.run(f.Device),k.run(f.EventStream))};m.parentNode.insertBefore(c,m);var f=
